...
Our team has also been instrumental in acquiring, wrangling, and summarizing spatial data. For the Silica Exports working group we developed a workflow (see [here](https://github.com/lter/lterwg-si-export)) that accomplishes teh following tasks:
