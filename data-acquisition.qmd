...
"Copy a previous request"

#### 4. Fill out Request


Request Name (for your future use)


Draw polygon over area of interest (*note data download limitation)


Pick data product(s) to include in request


Choose output file format (raster vs. netCDF)


Choose projection system (**so** helpful!)

Click "Submit"

#### 5. Download Completed Request

Await email notification of request **completion**

Will receive a "Request Received" email first and then some time later (longer for bigger requests) will get a "Request Complete" email
