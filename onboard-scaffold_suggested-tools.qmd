...
- Project management platforms: [Redmine](https://www.redmine.org/) or [GitHub Enterprise](https://github.nceas.ucsb.edu/)
- Documents sharing: Google Drive
- Code versioning and sharing: [GitHub](https://github.com/) (Note that NCEAS manages its own Enterprise instance)
- Video Conferencing: [Zoom](https://www.it.ucsb.edu/zoom) and GoToMeeting
- Chat room: [Slack](https://help.nceas.ucsb.edu/NCEAS/Computing/chat_room_setup.html)
- Mailing list: [manage your Google Group](https://help.nceas.ucsb.edu/NCEAS/Computing/google_group_wg.html)

**To get an account for any of these web services, please contact _help@nceas.ucsb.edu_ mentioning your working group**
